...
describe("Product Utility Testing", () => {
    test('Test Case 1: should convert 100 dollars into rupiah', () => {
    ...
    test('Test Case 2: should handle discount calculation correctly', () => {
      const discountedPrice = countDiscount(1000, 10);
      // Ensure that the discount calculation is accurate
      expect(discountedPrice).toBe(900);
    });
  
    test("Test Case 3: it should handle zero discount", () => {
      const price = 1000;
      const discount = 0;
